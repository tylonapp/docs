---
title: "Tylon: Git's control panel"
description: "Tylon is where work lives and where Git happens. A column is a real branch, moving a card is a real merge. These docs cover the public API and the MCP server."
...
<Card title="Start here" icon="book-open" href="/en/concepts/cards">
...
<Card title="Public API" icon="plug" href="/en/api-reference/introduction">
...
<Card title="MCP server" icon="terminal" href="/en/mcp/connect">
