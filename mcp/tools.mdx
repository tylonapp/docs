...
The public API has both too, as JSON rather than sentences — see [Checks and reviews](/api-reference/endpoints/forge).
...
It is also the difference from the [public API](/api-reference/errors), where a refusal is a status code because the reader is a program.
